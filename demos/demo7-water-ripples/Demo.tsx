...
export default class Demo extends React.Component {
  ...
  render() {
    ...
    return <TransitionMotion willLeave={this.willLeave} styles={styles}>
        {circles => <div onMouseMove={this.handleMouseMove} onTouchMove={this.handleTouchMove} className="demo7">
            {circles.map(({
          key,
          style: {
            opacity,
        ...
        }) => <div key={key} className="demo7-ball" style={{
          opacity: opacity,
          scale: scale,
