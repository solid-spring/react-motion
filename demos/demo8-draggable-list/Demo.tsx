  ...
  render() {
    ...
    return <div className="demo8">
        ...
        return <Motion style={style} key={i}>
            ...
            shadow,
            y
          }) => <div onMouseDown={this.handleMouseDown.bind(null, i, y)} onTouchStart={this.handleTouchStart.bind(null, i, y)} className="demo8-item" style={{
