...
const allColors = ['#EF767A', '#456990', '#49BEAA', '#49DCB1', '#EEB868', '#EF767A', '#456990', '#49BEAA', '#49DCB1', '#EEB868', '#EF767A'];
...
export default class Demo extends React.Component {
  ...
  handleMouseDown = (key, [pressX, pressY], {
    pageX,
    pageY
  }) => {
    this.setState({
  ...
  render() {
    ...
    return <div className="demo2">
        ...
        return <Motion key={key} style={style}>
              {({
            translateX,
            translateY,
            scale,
            boxShadow
          }) => <div onMouseDown={this.handleMouseDown.bind(null, key, [x, y])} onTouchStart={this.handleTouchStart.bind(null, key, [x, y])} className="demo2-ball" style={{
