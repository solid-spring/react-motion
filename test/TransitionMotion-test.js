...
const injector = require('inject-loader!../lib/TransitionMotion');
...
describe('TransitionMotion', () => {
  ...
  it('should allow returning null from children function', () => {
    class App extends React.Component {
      render() {
        ...
        return (
          <TransitionMotion styles={[{ key: '1', style: {} }]}>
            {() => null}
          </TransitionMotion>
        );
      }
  ...
  it('should interpolate many values', () => {
    ...
    expect(count).toEqual([
      ...
      [
        {
          key: '1',
          style: { a: 0.4722222222222222, b: 28.888888888888886 },
          data: undefined,
        },
      ...
      [
        {
          key: '1',
          style: { a: 1.1897376543209877, b: 57.589506172839506 },
          data: undefined,
        },
      ...
      [
        {
          key: '1',
          style: { a: 2.0123698988340193, b: 90.49479595336075 },
          data: undefined,
        },
      ...
      [
        {
          key: '1',
          style: { a: 2.8557218143909084, b: 124.22887257563633 },
          data: undefined,
        },
  ...
  it('should invoke didLeave in last frame', () => {
    ...
    mockRaf.step(999);
    expect(count).toEqual([{ key: '1', data: undefined }]);
  });
  ...
  it('should support jumping to value', () => {
    ...
    class App extends React.Component {
      ...
      render() {
        return (
          <TransitionMotion
            styles={[
              { key: '1', style: { x: this.state.p ? 400 : spring(0) } },
            ]}
          >
            {([{ style }]) => {
              count.push(style);
    ...
    expect(count).toEqual([{ x: 0 }, { x: 0 }, { x: 400 }]);
    setState({ p: false });
    mockRaf.step(3);
    expect(count).toEqual([
      { x: 0 },
